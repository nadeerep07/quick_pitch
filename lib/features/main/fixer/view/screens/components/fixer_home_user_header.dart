...
class FixerHomeUserHeader extends StatelessWidget {
  const FixerHomeUserHeader({
    super.key,
  ...
  Widget build(BuildContext context) {
    final imageUrl = (state.userProfile.profileImageUrl?.isNotEmpty ?? false)
