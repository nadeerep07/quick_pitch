...
import 'package:quick_pitch_app/features/onboarding/view/widdgets/onboarding_image.dart';
import 'package:quick_pitch_app/features/onboarding/view/widdgets/onboarding_texts.dart';
...
import '../components/onboarding_dot_indicator.dart';
  ...
  final List<Map<String, String>> pages = [
    {
      ...
      'subtitle': 'Describe your need, set a budget, and find a skilled fixer instantly.',
    },
    {
    ...
    return BlocProvider(
      ...
      child: BlocBuilder<OnboardingBloc, OnboardingState>(
        builder: (context, state) {
          final currentPage = pages[state.currentIndex];

          return Scaffold(
            body: Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                OnboardingImage(imagePath: currentPage['image']!, index: state.currentIndex, res: res),
