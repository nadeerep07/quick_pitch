...
import 'package:quick_pitch_app/features/requests_pitches/fixer/view/components/pitch_card.dart';
                    ...
                    (_) => BlocProvider(
                      create:
                          (context) { 
                            ...
                            pitchRepository: PitchRepository(), paymentRequestService: PaymentRequestService(),
                          );
