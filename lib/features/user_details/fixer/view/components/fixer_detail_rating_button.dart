...
class FixerDetailRatingButton extends StatefulWidget {
  ...
  @override
  State<FixerDetailRatingButton> createState() =>
      _FixerDetailRatingButtonState();
}

class _FixerDetailRatingButtonState extends State<FixerDetailRatingButton> {
  final ReviewService _reviewService = ReviewService();
  final UserProfileService _userProfileService = UserProfileService();
  bool _showReviews = false;
  Map<String, UserProfileModel> _reviewerProfiles = {};
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Row(
          children: [
            // Rating chip (clickable to expand reviews)
            GestureDetector(
              onTap: () {
                setState(() {
                ...
                child: Row(
                  ...
                  children: [
                    Icon(Icons.star_rounded,
                        size: widget.res.sp(16), color: Colors.amber),
                    SizedBox(width: widget.res.wp(1)),
                    Text(
                      widget.fixer.fixerData?.ratingStats?.averageRating
                              .toStringAsFixed(1) ??
                          '0.0',
                      style: TextStyle(
                    ...
                    SizedBox(width: widget.res.wp(1)),
                    Text(
                      '(${widget.fixer.fixerData?.ratingStats?.totalReviews.toString() ?? '0'})',
                      style: TextStyle(
