...
class FixerDetailRatingButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: _FixerDetailRatingContent(
        res: res,
...
class _FixerDetailRatingContent extends StatelessWidget {
  final Responsive res;
  final ColorScheme colorScheme;
  final UserProfileModel fixer;
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          fixer.fixerData?.ratingStats?.averageRating
                                  .toStringAsFixed(1) ??
                              '0.0',
                          style: TextStyle(
                            fontSize: res.sp(14),
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return FutureBuilder<UserProfileModel?>(
                            ...
                            builder: (context, profileSnapshot) {
                              ...
                              return _reviewCard(
                                  review, reviewerName, reviewerImage);
                            },
                          );
                        },
                      ),
  ...
  Widget _reviewCard(
      ReviewModel review, String reviewerName, String? reviewerImage) {
    return Container(
      width: res.wp(70),
